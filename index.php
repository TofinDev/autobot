...
<tr> 
    <td width="50" align="center" > <input name="chk[]" type="checkbox" class="css_data_item" id="data_item1" value="Kridsakorn" /> </td>  
    <td >  <pre class="btn btn-lg btn-info"> Kridsakorn</pre></td> 
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <tr> 
    <td width="50" align="center"> <input name="chk[]" type="checkbox" class="css_data_item" id="data_item1" value="Somsak" /> </td>  
    <td> <pre  class="btn btn-lg btn-info"> Somsak</pre></td> 
  </tr>	
  <td></td>  
  </tr>
  </tr>  
